...
- [[#Vorlesung 4 Teil 1|Vorlesung 4 Teil 1]]
	- [[#Vorlesung 4 Teil 1#Organisationstyp Prokaryoten (Wiederholung)|Organisationstyp Prokaryoten (Wiederholung)]]
...
- [[#Vorlesung 6|Vorlesung 6]]
	...
	- [[#Vorlesung 6#U-Reich Heterokontobionta|U-Reich Heterokontobionta]]
		- [[#U-Reich Heterokontobionta#Braunalgen (Phaeophyceen)|Braunalgen (Phaeophyceen)]]
			- [[#Braunalgen (Phaeophyceen)#Braunalgen Fortpflanzung|Braunalgen Fortpflanzung]]
...
- [[#Vorlesung 10|Vorlesung 10]]
	- [[#Vorlesung 10#Samenpflanzen (Spermatophytina)|Samenpflanzen (Spermatophytina)]]
		...
		- [[#Samenpflanzen (Spermatophytina)#Angiospermen (Bedecktsamer)|Angiospermen (Bedecktsamer)]]
...
- fast durchweg begeiß. Gameten (sind ja im wasser)
- Iso- bis Oogamie
...
- Verzweigte Alge
- System wächst mit einer einzigen Scheitelzelle (Einschneidig := kann sich nur in eine Richtung teilen 
...
- Man sieht den Gametophyt (Grün im Bild) (Unten Links ) = Antheridien
- Man sieht wie die Spermatozoide (enstanden durch **mitose** (im diagramm selbe Farbe)) zu den Archegonien "schwimmt"
- Das Archegonium hat zentral eingelassen eine Eizelle (Nicht mobil)
- Halskanal war ursprünglich zugewachsen öffnet sich aber und wird dann Chemotaktisch angelockt
- Dann kommt es zur Befruchtung und die Zygote wird gebildet
- Die Zygote wächst aus der Strutkur heraus aber bleibt im Gametophyt (das Schwarze im Diagramm und gelbe im Bild)
- Das Braune in der Calypta ist das Ursprügliche gametische gewebe (oft gelb oben getrocknet auf dem moss)
- In der Sporenkapsel (calypta) hat man 4 braune Zellen (**meiose ist passiert**) 
- Die Meiosporen werden durch aufbrechen der Kapsel in die Umwelt gelassen
- hier sind sie Isospor und keimen wieder aus
- Die Bilden dann eine Wneigzellige Strukur (Protonema)
- Da wächst wieder der Gesamte Gametophyt raus 
- Der Sporophyt wird hier durch den Gametophyt ernährt := Gonotrophie: „Ernährung durch den Erzeuger“
![[Bildschirmfoto 2024-12-30 um 19.59.32.png]]
*Links Antheridium, Rechts Archegonium*
### Moose 3 Gruppen
#### 1. Hornmoose (100 Arten)
![[Bildschirmfoto 2024-12-30 um 20.08.14.png]]
Gefährdet in Europa
Wächst auf Äckern
#### 2. Lebermoose (350 Arten)
![[Bildschirmfoto 2024-12-30 um 20.08.59.png]]
- … Stomata nur im Sporophyten
#### 3. Laubmoose
![[Bildschirmfoto 2024-12-30 um 20.09.22.png]]
### Landschaftsbestimmende Moose: Hochmoore mit Torfmoosen (Sphagnum)
![[Bildschirmfoto 2024-12-30 um 20.11.30.png]]
![[Pasted image 20241230201204.png]]
- Die Moore bilden Torfschichten über millionen von Jahre
>[!info] Schwarzer Hochmoortorf hat einen Brennwertfaktor von 1:3 zu Kohle
>- Es ist also sehr viel $CO_{2}$ dicht gespeichert
>- $Co_{2}$ Senken
### Landschaftsbestimmende Moose: Kalktuffbildung (Cratoneuron)
![[Bildschirmfoto 2024-12-30 um 20.14.49.png]]
- Versteinerte Moosriffe
- Viel Wasser aus Kalkhaltigen Regionen
- Verkalken und dadurch entsteht ein Wettrenen gegen das Wasser -> Kalktuffe
- Diese Lebensräume gehen bis nach Südostasien
---
# Vorlesung 9 (Teil 2 von 8)
## Who was first, plants or animals ? (nicht Prüfungsrelevant)
![[Pasted image 20241230222434.png]]

![[Pasted image 20241230222508.png]]
- Keine Umgebung ist perfekt aber Lebens ist überall
- zb. pyrococcus furiosus
	![[Pasted image 20241230222541.png]]
### Snowball Earth
![[Pasted image 20241230222443.png]]
	Snowball earth (717-660 mya und 650-635 mya)
![[Pasted image 20241230222759.png]]
## O-Typ Pteridophyten (Farngewächse)
![[Bildschirmfoto 2024-12-30 um 22.32.52.png|400]]
- Es sind auch: Embryophyten (schützen den Embryo), Tracheophyten (haben Leitgewebe), Archegoniaten (haben Archegonien)
- Spross, Blätter und Wurzeln mit echten Leitbündeln und Lignin
- meist Scheitelzellen
- weltweit, zumeist feuchte Standorte (da Spermatoide)
Gruppen:
- Psilophytales  (Urfarngewächse, **noch keine Wurzeln**) 	
- Lycopodiophytina (Bärlappgewächse) 
- Psilotophytina (Gabelblattgewächse) 
- Equisetophytina (Schachtelhalmgewächse) 
- Marattiophytina (auch z.T. große Farne) 
- Filicophytina (echte Farne)
### Generationswechsel Echte Farne 
- 10.000 Arten
- Sporophyt dominiert (Bei moos dominiert der Gametophyt)
![[Bildschirmfoto 2024-12-30 um 22.34.46.png]]
Ablauf (Sporophyt Schwarz):
 Starten bei Schritt 4 im Diagramm:
1. Die Farnpflanze ist diploid und besitzt Wurzeln, Sprosse und Blätter.
    
2. Auf der Unterseite der Blätter befinden sich Sporangien, in denen Sporen gebildet werden.
    
3. Diese Sporangien sind in Gruppen angeordnet.
    
4. Sie sind sichtbar, wenn man die Blattunterseite umdreht.  
    ![[Pasted image 20241230223714.png]]
    
5. Blickt man in ein Sporangium, erkennt man, dass im Inneren durch eine Reduktionsteilung haploide Zellen gebildet werden (Meiosporen). (Schritte 5, 6 und F)
    
6. Die äußere Struktur des Sporangiums wird Annulus genannt.
    
7. Der Annulus trocknet aus, wodurch das Sporangium aufbricht und die Sporen freigesetzt werden.
    
8. Diese Sporen werden vom Wind verbreitet.
    

Übergang zu Gametophyten:

9. Die haploiden Meiosporen wachsen zu einem Gametophyten heran.
    
10. Der Gametophyt hat ein moosartiges, thallöses Erscheinungsbild.
    
11. Er besitzt rhizoidartige Strukturen.
    
12. Der Gametophyt bildet die Gameten.
    
13. Antheridien (männliche Gametangien) und Archegonien (weibliche Gametangien) entstehen. (Schritt 3)
    
14. Durch Befruchtung wird die Eizelle befruchtet.
    

Übergang zu Sporophyten:

15. Aus dem Gametophyten wächst schnell ein neuer Sporophyt heran.
    
16. Der Gametophyt ernährt den Sporophyten nicht.
    
17. Manche Farne sind isospor (bilden nur eine Art von Sporen).
![[Pasted image 20241230224201.png]]
*Gametophyt eines Farnes*
### Psilophytales † (Urfarngewächse)
- Silur/Devon (v. 400 Mio. J.) 
- z.B. *Rhynia* 
- Zweigabelig
- Leitbündel
- Am ende der Arme haben wir "Sporangien"
- Telome, noch keine echten Wurzeln
![[Bildschirmfoto 2024-12-30 um 22.46.40.png]]
![[Bildschirmfoto 2024-12-30 um 22.46.47.png]]
- Klar zu erkennen ist eine epidermis mit einer Caticula
- Auch sieht man Stomata am vermeintlichen Sporophyten
### Marattiophytina | 200 Arten
- z.B. Angiopteris, Marattia
- ![[Bildschirmfoto 2024-12-30 um 22.47.15.png]]
### Equisetophytina (Schachtelhalmgewächse)
- Equisetum (32 Arten), Calamites †
- ![[Bildschirmfoto 2024-12-30 um 22.56.30.png]]
- ![[Pasted image 20241230225714.png]]
*Calamites Vorstellung*
### Psilotophytina (Gabelblattgewächse)
- Die Noch heute Lebenden, nicht die Urfarne !
- Psilotum (2 Arten), Tmesipteris (4), Ophioglossaceae (80)
- ![[Bildschirmfoto 2024-12-30 um 22.58.03.png]]
- ![[Bildschirmfoto 2024-12-30 um 22.58.08.png]]
### Lycopodiophytina (Bärlappgewächse)
- *Lycopodium*/Huperzia (400 Arten), *Selaginella* (700), *Isoetes* (60)
-  *Lepidodendron* †, *Sigillaria* †
![[Bildschirmfoto 2024-12-30 um 22.59.15.png]]
*Bärlapp (Lycopodium annotinum) mit Sporophyllähren*

>[!info] Zusammenfassung der wichtigsten Begriffe
>- Bryophyta (Leber- Laub- Hornmoose) 
>- Generations- und Kernphasenwechsel eines Laubmooses 
>- Antheridium, Archegonium, … 
>- Tracheophyten 
>- Pteridophyten (Urfarne, Bärlappe, Schachtelhalme, Echte Farne, Gabelblattgewächse) Generations- und Kernphasenwechsel eines „Echten Farnes“

>[!info] Lebenszyklus der Selaginella (Bärlappgewächse)  
>![[Bildschirmfoto 2024-12-30 um 23.01.32.png]]  
>- Selaginella gehört zur Gruppe der **Bärlappgewächse** (Lycophyten).  
>- Es handelt sich um eine **heterospore Farnart**, was bei Farnen selten vorkommt.  
>- **Heterosporie** bedeutet, dass der Sporophyt zwei verschiedene Typen von Sporangien bildet:  
>  1. Es gibt ein Sporangium, das **kleine Sporen** (Mikrosporen) durch Meiose produziert.  
>  2. Das andere Sporangium bildet **große Sporen** (Megasporen).  
>- **Verteilung:** Diese beiden Sporangien-Typen sind innerhalb der Struktur unterschiedlich angeordnet.  
>- Aus den **Mikrosporen** entsteht ein männlicher Gametophyt.  
>- Aus den **Megasporen** entsteht ein weiblicher Gametophyt.  
>- Der **männliche Gametophyt** bildet ausschließlich **Antheridien**, in denen Spermazellen gebildet werden.  
>- Der **weibliche Gametophyt** bildet ausschließlich **Archegonien**, die eine große, unbegeißelte Eizelle enthalten.  
>- Die große, unbegeißelte **Eizelle** wird durch die Spermazellen befruchtet.  
>- Dies geschieht innerhalb des weiblichen Gametophyten im Gametangium. Das nennt man **Endosporie**.  
>- Anders als bei Moosen und Farnen, bei denen die Befruchtung im Archegonium stattfindet, bleibt die befruchtete Eizelle hier im Gametophyten.  
>- Die befruchtete Eizelle wird in den Gametophyten eingebunden und wächst zu einer **Zygote** heran.  
>- Die Zygote wächst aus dem Gametophyten heraus und entwickelt sich mit einer Hauptwurzel weiter.  
>- **Schlüsselinnovation:** Hier zeigt sich die Entwicklung der Trennung von männlichen und weiblichen Strukturen, was eine effektivere Fortpflanzung ermöglicht.  

---
# Vorlesung 10
## Samenpflanzen (Spermatophytina)
![[Bildschirmfoto 2024-12-30 um 23.23.51.png]]
- 50 000 arten
- Spermatophyten (gelten als monophyletisch)
	- Gymnospermen *(monopyletisch)*
	- Angiospermen *(monophyletisch)*
- "Erfindung“ des Samens = **Ausbreitungseinheit**
	- Samenschale, Embryo, Nährgewebe
		- (Moose & Farne sind Sporenpflanzen) (und haben **Sporen** genutzt)
	- Zb Kokosnuss
- G-Wechsel mit <span style="color:rgb(199, 0, 0)">Hetero- & Endosporie</span> 
### Gymnospermen (Nacktsamer) 
- 1.200 Arten
- Nacktsamigkeit = Samenanlage ist frei zugänglich
-  4 bzw. 3 (**rezente**) Gruppen
	- *Cycadopsida* (Palmfarne)
	- *Ginkgopsida* (Ginkgo)
	- *Coniferopsida* (Nadelbäume) (inkl. Gnetales)
>[!Beispiel] Pinienkerne
>- Große Pinenzapfen
>- Wenn man den Zapfen Schüttelt fallen die Samen einfach raus 
>- **Nacktsammer**

>[!Beispiel] Apfel
>- Wenn man einen Apfel lange schüttelt wird der Same niemals herausfallen
>- **KEIN Nacktsamer**

#### Cycadeen (Palmfarne)
- 300 Arten
- z.B. *Cycas revoluta* (Japanischer Sagopalmfarn)
	- ♂ & ♀ Pflanzen
![[Bildschirmfoto 2024-12-30 um 23.30.35.png]]
- Spermatozoide (400 μm!)
- ![[Bildschirmfoto 2024-12-30 um 23.30.50.png]]

#### Ginkgo biloba
- Spermatozoide, auch zweihäusig
- ![[Bildschirmfoto 2024-12-30 um 23.31.13.png]]
- Gestank des Weiblichen Ginkobaumes (Scheinfrucht)
#### Coniferen
 - keine Spermatozoiden, Pollenschlauchbefruchtung
![[Bildschirmfoto 2024-12-30 um 23.43.01.png]]
- Schwarz hier die Diploide Generation (Also der Sporophyt)
- Braun hier die Haploide Generation (Also der Gametophyt)

- Ast der Männliche Samen Produziert (links)
- Ast der Weibliche Samen Produziert (Rechts) 
- Zapfen := Kurzer Spross an dem ganz viele Blättchen hängen die den Zapfen bilden

Starten bei D:
- Tragplatt (Von außen verholzt)
- Auf diesem Sporophytischem Gewebe wird eine Samenanlage gebildet
- Daraus folgern wir dass in de Gewebe muss eine Diploide zelle durch eine meiose laufen
- Denn so entshet eine Meiospore
- Hier die Megaspore da wir die Weibliche Pflanze betrachten
- Auch Megasporenmutterzelle gennant
- Es entshehen 4 megasporen, 3 sterben aber 1 teilt sich metodisch 
- Es enthset haploidisches gewebe (Braun gezeichnet)
- Der Weibliche Gametophyt wird größer 
- Er bildet gameten aus (Eizellen da er weiblich ist)
- Da enstehen jetzt einzele zellen die sich zu Archegonien entwickeln
- Darin entstehen dann die Eizellen 
- Damit ist die Entwicklung des Weiblichen Gametophyten abgeschlossen

- Der Männliche Gametophyt bildet ganz analog haplodies Gewebe innerhalb dieses Sporophytischen gewebes
- Das sind jetzt aber Mikrosporen
- Hier haben wir jetzt Haploide Zellen die jeder für sich in einen Pollenkorn verfrachtet 
- In dem Pollen entwicklet sich der Männliche Gametophyt
- Der Wird dann auf die reise geschickt (meist Windbestäubt)
- Der Pollen gelangt zur Samenanlage 
- Dann kommt es zur befruchtung
- Zygote
- Embryo
- Dann entsteht der Same in Gametophytischem Gewebe und außen Sporophytisches Gewebe
- Diese Struktur lösst sich dann als Same der Pinie und keimt dann wieder neu aus

>[!info] Verbessert
>Hier ist die überarbeitete und optimierte Version der Stichpunkte:
 **Weibliche Fortpflanzungsstrukturen**
>
> - Tragblatt: Von außen verholzt.
> - Auf diesem sporophytischen Gewebe wird eine Samenanlage gebildet.
> - In diesem Gewebe durchläuft eine diploide Zelle eine Meiose.
>     - Dabei entsteht eine **Meiospore**.
> - Da es sich um die weibliche Pflanze handelt, spricht man hier von der **Megaspore**.
>     - Die Zelle wird auch **Megasporenmutterzelle** genannt.
> - Es entstehen vier Megasporen, von denen drei absterben.
>     - Eine Megaspore teilt sich **mitotisch**.
> - Es bildet sich haploides Gewebe (häufig braun dargestellt).
> - Der weibliche Gametophyt wächst heran.
>     - Er bildet **Gameten** aus, in diesem Fall **Eizellen**.
> - Einzelne Zellen des Gametophyten entwickeln sich zu **Archegonien**, in denen die Eizellen entstehen.
> - Mit der Bildung der Eizellen ist die Entwicklung des weiblichen Gametophyten abgeschlossen.
> 
> **Männliche Fortpflanzungsstrukturen**
> 
> - Der männliche Gametophyt entwickelt sich analog:
>     - Auch hier bildet sich haploides Gewebe innerhalb sporophytischen Gewebes.
>     - Statt Megasporen entstehen **Mikrosporen**.
> - Haploide Zellen werden in **Pollenkörner** verpackt.
> - Im Pollenkorn entwickelt sich der männliche Gametophyt.
> - Der Pollen wird meist durch den Wind verbreitet und gelangt zur Samenanlage.
> 
> **Befruchtung und Entwicklung des Samens**
> 
> - Der Pollen erreicht die Samenanlage, und es kommt zur **Befruchtung**.
>     - Aus der Zygote entwickelt sich ein **Embryo**.
> - Der Embryo wird in den Samen eingeschlossen, der aus:
>     - Gametophytischem Gewebe (innen)
>     - Sporophytischem Gewebe (außen) besteht.
> - Der Same löst sich schließlich ab und keimt unter geeigneten Bedingungen zu einer neuen Pflanze aus.
> 

##### Coniferen – Pinus | Entwicklung ♂ Gametophyt
![[Bildschirmfoto 2024-12-30 um 23.58.31.png]]
> [!info] Entwicklung der Pollenzelle (haploide Mikrospore)  
> - **Ausgangspunkt:** Die Pollenzelle ist eine haploide Mikrospore.  
> - **Erste Teilung:**  
>   - Die Pollenzelle teilt sich in zwei Zellen:  
>     1. **Prothalliumzelle 1**  
>     2. **Prothalliumzelle 2 und Antheridienzelle** (durch weitere Teilung der zweiten Zelle).  
> - **Zweite Teilung:**  
>   - Die **Antheridienzelle** teilt sich in:  
>     - **Pollenschlauchzelle**: Verantwortlich für das Wachstum des Pollenschlauchs.  
>     - **Generative Zelle**: Entwickelt die männlichen Gameten.  
> - **Dritte Teilung (in der generativen Zelle):**  
>   - Die **Generative Zelle** teilt sich in:  
>     - **Stielzelle**: Unterstützungsfunktion.  
>     - **Spermatogene Zelle**: Entwickelt die Spermazellen.  
> - **Endstadium:**  
>   - Die **Spermatogene Zelle** bildet zwei **Spermazellen**.  
> - **Bedeutung:**  
>   - Die beiden Spermazellen sind zur Befruchtung der Eizelle nötig. Eine dieser Zellen verschmilzt mit der Eizelle zur Bildung der Zygote.  

##### Coniferen – Pinus | Entwicklung ♀ Gametophyt
- Entwicklung innerhalb der Samenanlage & **<span style="color:rgb(199, 0, 0)">innerhalb</span>** der Megaspore
	- etwa 1.000 Zellen & Archegonium noch erkenn-/deutbar
- Megaprothallium<span style="color:rgb(199, 0, 0)">*</span> = prim. Endosperm (haploid)
![[Bildschirmfoto 2024-12-30 um 23.41.55.png|300]]
- Beim weiblichen Gametophyten, ensteht die Samenanlage in dem Sporophytischen Gewebe
- Die Gesamte Struktur besteht aus ca 1000 zellen
- Öffnung oben 
- Eizelle
- Bauchkanalzelle
- Pollen muss mit dem Pollenschlauch hinabwachsen und die Männlichen Spermazellen zur Eizelle bringen


> [!Info] Dauer der Entwicklung
> - Da diese Entwicklung 15 Monate dauert sieht man immer 2 verschiedene Zapfen 
> - Die Befruchtung passiert also erst im nächsten jahr !
> - Das ist nicht wirklich optimiert 
> - Auch das in nur einem Samen 1 Embryo sich bilden kann ist interessant, währen jedoch mehrere drinnen wäre der Konkurrenzkampf zu Drastisch für alle (deswegen sind zwilling, trilling,... geburten Seltener)

#### Coniferopsida (inkl. Gnetales)
![[Bildschirmfoto 2024-12-31 um 00.16.45.png]]
### Angiospermen (Bedecktsamer) 
- 270.000 Arten
-  Angiospermen = Blütenpflanze
	- „Erfindung“ (echte) Blüte
	- Bedecktsamigkeit (Fruchtblätter)
		- "Erfindung“ Frucht
	- doppelte Befruchtung
![[Bildschirmfoto 2024-12-31 um 00.18.01.png]]
#### Angiospermen (Bedecktsamer) - Lebensyzklus
![[Bildschirmfoto 2024-12-31 um 00.20.03.png]]
- **Der Sporophyt**:
	- Die dominante, sichtbare Generation bei den Bedecktsamern.

**Blütenbestandteile**

1. **Kelchblätter (Sepalen):**
    
    - Äußere Hülle der Blüte, schützt die inneren Strukturen.
2. **Staubblätter (Mikrosporophylle):**
    
    - Analog zu den Mikrosporophyllen beim Farn.
    - Bestehen aus einem **Staubfaden** (filamentartige Struktur) und einem **Staubbeutel**.
        - Im Staubbeutel befinden sich die **Mikrosporangien**, in denen **Pollenkörner** (Mikrosporen) gebildet werden.
    - Die **Pollenkörner** sind die männlichen Gametophyten.
3. **Fruchtblätter (Karpelle):**
    
    - Befinden sich in der Mitte der Blüte, oft miteinander verwachsen.
    - Zusammen bilden sie den **Fruchtknoten**, der die Samenanlagen enthält.
    - In den Samenanlagen entstehen:
        - **Megasporen** (durch Meiose) → Entwickeln sich zu weiblichen Gametophyten.
        - Der weibliche Gametophyt bildet das **Archegonium** aus, in dem die **Eizelle** gebildet wird.

 **Befruchtung**

- **Doppelte Befruchtung** (charakteristisch für Bedecktsamer):
    - Ein Pollenschlauch transportiert zwei Spermazellen zur Samenanlage.
        1. Eine Spermazelle befruchtet die **Eizelle** → Bildung der **Zygote** (2n).
        2. Die andere Spermazelle verschmilzt mit den **Polkernen** → Bildung des **Endosperms** (3n), das als Nährgewebe dient.

**Entwicklung des Samens und der Frucht**

- Nach der Befruchtung entwickelt sich:
    - Die Zygote → **Embryo** (neue Pflanze).
    - Die Samenanlage → **Samen**.
    - Der Fruchtknoten → **Frucht**, die den Samen schützt und bei der Verbreitung hilft.

**Keimung**

- Unter geeigneten Bedingungen keimt der Same und entwickelt sich zu einem neuen Sporophyten, der den Lebenszyklus abschließt.
##### Angiospermen | Entwicklung ♂ Gametophyt
![[Pasted image 20241231002602.png]]
- Pollenkorn besteht aus einer Vegetativen Zelle mit Kern und Generativen Zelle 
- Der Fruchtknoten hat oben eine Narbe und dort landen die Pollenkörner und Keimen dann aus mit einem sog. Pollenschlauch 
- Der Pollenschlauch geht bis in die Samenanlage
- Beim Auskeimen teilt sich die generative Zelle (g) in 2 Spermazellen (s) geteilt
- Nur 3 Zellen !

##### Angiospermen | Entwicklung ♀ Gametophyt
![[Bildschirmfoto 2024-12-31 um 00.29.38.png]]
- In dem Gewebe wird eine Zelle als Embryosackmutterzelle (diploid) heranwächst
- Diese durchläuft dann eine Meiose sodass wie 4 Halpoide Zellen bekommen (in der Regel gehen davon 3 zu grunde)
- Dieser Weibliche Embryophyt durchläuft nur noch 3 freie Kernteilungen
- Letztendlich haben wir eine Große Strukur mit 8 Zellkernen in dieser Strukur 
	- Synergiden 2
	- Eizelle
	- Antiopden 3 
	- 2 Zellkerne die miteinander Verschmelzen (k), das heißt Sekundererembryosackkern
- Drum herum haben wir Sporophytsiche Zellschichten
	- i inneres Integument 
	- a äußeres Integument
![[Bildschirmfoto 2024-12-31 um 00.33.59.png]]
##### Angiospermen | Entwicklung Befruchtung
- Der Pollen landet oben auf der Narbe
- Der Pollenschlauch wächst durch das Gewebe bis in die Samenanlage
- Entlässt die 2 Spermakerne
- 1 muss die Eizelle befruchten
- Triploides Endosperm
- Das Triplode Endosporm entwickelt sich genauso wie das Embryo und werden von der Mutterpflanze ernährt
- Der Same Entwickelt sich mit dem Embryo und dem Endosporn 
- Also anderst bei den Nacktsammern
- Struktur kann nur eine einzele Eizelle und damit eine Zygote und Embryo entwicklen

>[!info] Zusammenfassung der wichtigsten Begriffe
>![[Bildschirmfoto 2024-12-31 um 00.39.03.png]]
>- Homolegesierung der Verschiedenen Strukturen und Begriffen 
>- Die Abbildung vernachlässigt visuell aber das Prinzip der Reduzierung des Gametophyten
>![[Bildschirmfoto 2024-12-31 um 00.41.36.png]]
